...
class Client(object):
    ...
    def _request(self, method, request_path, params, timeout: int | None = 30, cursor=False):
        if method == c.GET:
    ...
    def _request_without_params(self, method, request_path, timeout: int | None = 30):
        return self._request(method, request_path, {}, timeout)

    def _request_with_params(self, method, request_path, params, timeout: int | None = 30, cursor=False):
